...
useragents = ('Mozilla/5.0 (Linux; Android 8.1.0; vivo 1812) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.110 Mobile Safari/537.36')
...
uas = 'Mozilla/5.0 (Linux; Android 8.1.0; vivo 1812) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.110 Mobile Safari/537.36'
ip = requests.get('https://api.ipify.org').text
uas = random.choice(["Mozilla/5.0 (Linux; Android 8.1.0; vivo 1812) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.110 Mobile Safari/537.36"])
id = []
cp = []
ok = []
loop = 0
...
def tokenz():
	...
	try:
		...
		print logo
		print""+p+""
		print"[+] Di Isi Ya Cukk Biarr Joss"
		token = raw_input('\n[+] Token : ')
		try:
